...
const es = {
  ...
  fields: {
    ...
    milesHelp: "El número exacto que marca. Sin comas ni puntos.",
  ...
  bodyTypes: {
    ...
    travel_trailer: "Trailer de viaje",
    camper: "Camper",
  ...
  form: {
    ...
    reorderHelp:
      "La primera foto es la que se ve en el listado. Usa las flechas para cambiar el orden.",
...
const en: Dict = {
  ...
  fields: {
    ...
    milesHelp: "The exact number it shows. No commas or periods.",
    price: "Asking price",
  ...
  form: {
    ...
    reorderHelp:
      "The first photo is the one shown in the listing. Use the arrows to change the order.",
