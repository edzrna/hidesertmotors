...
function getHDMLabel(score: number) {
  if (score >= 90) return "Best option";
...
export default function EnglishCarDetailPage() {
  ...
  const shareUrl =
    typeof window !== "undefined"
      ...
      : `https://www.hidesertmotors.com/en/car/${vehicle.id}`;
      ...
      <div style={{ maxWidth: "1220px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            >
              {(vehicle as any).detailsEn || vehicle.details}
            </p>
            ...
            >
              <InfoBox label="Year" value={String(vehicle.year)} />
              <InfoBox label="Miles" value={vehicle.miles.toLocaleString()} />
              <InfoBox label="Title" value={formatTitleStatus(vehicle.titleStatus)} />
              <InfoBox label="Owners" value={String(vehicle.owners)} />
              <InfoBox label="Accidents" value={String(vehicle.accidents)} />
              <InfoBox label="Condition" value={formatCondition(vehicle.condition)} />
            </div>
            ...
            >
              ...
              <button onClick={handleCopyLink} style={shareNetworkButtonStyle}>
                <ShareIconLink />
                <span>Copy link</span>
              </button>
            </div>
            ...
            >
              Main WhatsApp: {PRIMARY_WHATSAPP}
            </div>
          </div>
        </div>
      </div>
